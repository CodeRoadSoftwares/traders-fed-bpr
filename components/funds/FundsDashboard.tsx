  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      {isShop && !approvalLoading && !isApproved && (
        <div className="bg-warning-50 border border-warning-200 rounded-2xl p-6 text-center mb-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            You need to have an approved shop certificate to view fund details.
          </p>
          <Link
            href="/my-shop"
      ...
      {isShop && approvalLoading && (
        <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
          <Sk className="h-12 w-12 rounded-2xl mx-auto mb-4" />
          <Sk className="h-5 w-48 mx-auto mb-2" />
          <Sk className="h-4 w-64 mx-auto" />
        </div>
      )}

      {/* Only show funds content if approved or not a shop */}
      {(!isShop || isApproved) && (
        <>
          {/* Compact header */}
          ...
          <div className="flex gap-3 overflow-x-auto pb-1 -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-3 scrollbar-none mb-4">
            {[
              ...
              },
              {
                ...
                border:
                  balance >= 0 ? "border-primary-100" : "border-danger-100",
              },
            ].map((s) => (
              <div
                key={s.label}
          ...
          {!user && (
            <div className="flex items-start gap-2 px-3 py-2.5 bg-primary-50 border border-primary-100 rounded-xl text-xs text-primary-700 mb-4">
              ...
              Public transparency record — all federation income and expenses
              are listed here.
            </div>
          )}
          ...
          <div className="flex gap-2 mb-2">
            ...
            <select
              value={sortAmount}
              onChange={(e) =>
                setSortAmount(e.target.value as "" | "asc" | "desc")
              }
